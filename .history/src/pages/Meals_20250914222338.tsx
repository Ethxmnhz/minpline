              ...
              {editingId === m.id ? (
                <div className="card" style={{margin:0, background:'#1d2730'}}>
                  ...
                  <div className="row gap" style={{marginTop:4}}>
                    <input type="number" style={{flex:1}} value={editDraft.calories||''} onChange={e=>setEditDraft(d=>({...d,calories:+e.target.value}))} />
                    <input type="number" style={{flex:1}} value={editDraft.protein||''} onChange={e=>setEditDraft(d=>({...d,protein:+e.target.value}))} />
                    <input type="number" style={{flex:1}} value={editDraft.carbs||''} onChange={e=>setEditDraft(d=>({...d,carbs:+e.target.value}))} />
                    <input type="number" style={{flex:1}} value={editDraft.fats||''} onChange={e=>setEditDraft(d=>({...d,fats:+e.target.value}))} />
                  </div>
